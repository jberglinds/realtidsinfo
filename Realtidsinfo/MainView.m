...
- (IBAction)removeButtonPressed:(UIBarButtonItem *)sender {
    ...
    UIAlertAction *actionConfirm = [UIAlertAction actionWithTitle:@"Ta bort"
        ...
        if ([self.stopViewControllers count] == 0) {
            ...
            [self.pageViewController setViewControllers:@[[self.stopViewControllers lastObject]]
                                              direction:UIPageViewControllerNavigationDirectionForward
                                               animated:YES
                                             completion:nil];
        } else {
            [self.pageViewController setViewControllers:@[self.stopViewControllers[index]]
                                              direction:UIPageViewControllerNavigationDirectionForward
                                               animated:YES
                                             completion:nil];
        }
